...
float wheel_1_rotation_pid_unload[3] = {0.2, 0.001, 0.001};
...
float wheel_2_rotation_pid_unload[3] = {0.2, 0.001, 0.001};
...
float wheel_3_rotation_pid_unload[3] = {0.2, 0.001, 0.001};
...
float wheel_4_rotation_pid_unload[3] = {0.2, 0.001, 0.001};
...
bool robot::navCallback(nav::Service_msg::Request &request, nav::Service_msg::Response &response){
    ...
    else if(request.head_direction == 0){
        if(nav_Command.type == 1){
            nav_Command.velocity = -1*nav_Command.velocity;
        }
        else if(nav_Command.type == 2){
...
void robot::robotMove_Xaxis(int speed, int rotation){
    ...
    robot::wheelFL.setPID(1, std::abs(speed), robot::is_load);
    robot::wheelFR.setPID(1, std::abs(speed), robot::is_load);
    robot::wheelRL.setPID(1, std::abs(speed), robot::is_load);
    robot::wheelRR.setPID(1, std::abs(speed), robot::is_load);
...
void robot::robotMove_Yaxis(int speed, int rotation){
    ...
    robot::wheelFL.setPID(2, std::abs(speed), robot::is_load);
    robot::wheelFR.setPID(2, std::abs(speed), robot::is_load);
    robot::wheelRL.setPID(2, std::abs(speed), robot::is_load);
    robot::wheelRR.setPID(2, std::abs(speed), robot::is_load);
...
void robot::robotRotation(int speed, int rotation){
    ...
    robot::wheelFL.setPID(0, std::abs(speed), robot::is_load);
    robot::wheelFR.setPID(0, std::abs(speed), robot::is_load);
    robot::wheelRL.setPID(0, std::abs(speed), robot::is_load);
    robot::wheelRR.setPID(0, std::abs(speed), robot::is_load);
